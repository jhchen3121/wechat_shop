...
class Handler(handler.handler):
    ...
    def dispatch(self, session):
        ...
        if name:
            total = session.query(WechatshopGood, WechatshopCategory).join(WechatshopCategory, WechatshopGood.category_id == WechatshopCategory.id).filter(WechatshopGood.is_delete == 0).filter(WechatshopGood.name.like('%{}%'.format(name))).count()

            goods_onsal = session.query(WechatshopGood, WechatshopCategory).join(WechatshopCategory, WechatshopGood.category_id == WechatshopCategory.id).filter(WechatshopGood.is_delete == 0).filter(WechatshopGood.name.like('%{}%'.format(name))).order_by(WechatshopGood.sort_order.asc()).limit(limit).offset(offset).all()
        else:
            total = session.query(WechatshopGood, WechatshopCategory).join(WechatshopCategory, WechatshopGood.category_id == WechatshopCategory.id).filter(WechatshopGood.is_delete == 0).count()

            goods_onsal = session.query(WechatshopGood, WechatshopCategory).join(WechatshopCategory, WechatshopGood.category_id == WechatshopCategory.id).filter(WechatshopGood.is_delete == 0).order_by(WechatshopGood.sort_order.asc()).limit(limit).offset(offset).all()
