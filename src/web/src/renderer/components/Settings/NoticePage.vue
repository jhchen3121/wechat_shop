    ...
    export default {
        ...
        methods: {
            ...
            updateNotice() {
                ...
                this.axios.post(this.root + 'shop_set/update_notice', this.noticeData).then((response) => {
            ...
            goNotice() {
                ...
                this.axios.post(this.root + 'shop_set/create_notice', this.noticeData).then((response) => {
                    if (response.data.header.code === 0) {
                        this.$message({
                            type: 'success',
                            message: '添加成功!'
            ...
            handleRowDelete(index, row) {
                this.$confirm('确定要删除?', '提示', {
                    ...
                    this.axios.post(this.root + 'shop_set/delete_notice', {id: row.id}).then((response) => {
                        if (response.data.header.code === 0) {
                            this.$message({
                                type: 'success',
                                message: '删除成功!'
            ...
            getList() {
                this.axios.post(this.root + 'shop_set/show_notice').then((response) => {
