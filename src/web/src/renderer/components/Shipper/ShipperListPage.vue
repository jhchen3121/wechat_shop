...
export default {
	...
	methods: {
		...
		handlePageChange(val) {
			this.page = val;
			//保存到sessionStorage
			sessionStorage.setItem('shipperPage', this.page)
			sessionStorage.setItem('shipperFilterForm', JSON.stringify(this.filterForm));
			this.getList()
		},
		...
		getList() {
			this.axios.post(this.root + 'shop_set/show_shipper_list', {
				params: {
					page: this.page,
