        ...
        methods: {
            addSpec(){
                ...
                this.$refs['infoForm'].validate((valid) => {
                    if (valid) {
                        this.axios.post(this.root + 'specification/add', info).then((response) => {
            ...
            updateSpec(){
                ...
                this.$refs['infoForm'].validate((valid) => {
                    if (valid) {
                        this.axios.post(this.root + 'specification/update', info).then((response) => {
                            if (response.data.header.code === 0) {
                                this.$message({
                                    type: 'success',
                                    message: '保存成功!'
            ...
            specDelete(index, row) {
                this.$confirm('确定要删除?', '提示', {
                    ...
                    this.axios.post(this.root + 'specification/delete', {id: this.infoForm.id}).then((response) => {
            ...
            getInfo() {
                ...
                let that = this
                this.axios.post(this.root + 'specification/get_detail', {
                        id: that.infoForm.id
                }).then((response) => {
