        ...
        <div class="content-main clearfix">
            ...
            <div class="main">
                <el-tabs class="o-tab" v-model="activeName2" type="card" @tab-click="handleClick">
                    ...
                    <el-tab-pane label="最近500天" name="fourth"></el-tab-pane>
                </el-tabs>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getInfo() {
                this.axios.get(this.root + 'auth/index',).then((response) => {
                    this.infoData = response.data.body.info_data;
                })
            },
            ...
            getMainInfo(index) {
                this.axios.post(this.root + 'auth/main', {
                    params: {
                        pindex: index
                    }
                }).then((response) => {
                    this.mainInfo = response.data.body.main_info;
                    this.newData = response.data.body.main_info.newData;
                    this.oldData = response.data.body.main_info.oldData;
                    this.userData = this.newData;
        ...
        mounted() {
            ...
            this.getMainInfo(0);
            if(!this.loginInfo){
                this.loginInfo = JSON.parse(window.sessionStorage.getItem('userInfo') || null);
