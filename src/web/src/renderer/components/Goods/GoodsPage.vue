    ...
    export default {
        ...
        methods: {
            ...
            submitSort(index, row){
                this.axios.post(this.root + 'goods/change_goods_sort', { id: row.id,sort:row.sort_order }).then((response) => {})
            },
            ...
            handleRowDelete(index, row) {
                ...
                let that = this;
                that.axios.post(this.root+ 'goods/delete', {id: row.id}).then((response) => {
                    if (response.data.header.code === 0) {
                        that.$message({
                            type: 'success',
                            message: '删除成功!'
                        });
                        let pIndex = sessionStorage.getItem('pIndex');
                        if (!pIndex) {
                            pIndex = 1
                        }
                        console.log(pIndex);
...
//                    });
            ...
            getList() {
                this.axios.post(this.root + 'goods/get_all_goods_list', {
                    params: {
                        page: this.page,
						size: this.size,
            ...
            getOnSaleList() {
                this.axios.post(this.root + 'goods/onsale_list', {
                    params: {
                        page: this.page,
						size: this.size,
                        name: this.filterForm.name
            ...
            getOutList() {
                this.axios.post(this.root + 'goods/out_list', {
                    params: {
                        page: this.page,
						size: this.size,
                        name: this.filterForm.name
            ...
            getDropList() {
                this.axios.post(this.root + 'goods/drop_list', {
                    params: {
                        page: this.page,
						size: this.size,
                        name: this.filterForm.name
            ...
            changeStatus($event, para) {
                this.axios.post(this.root + 'goods/change_sale_status', {
                    params: {
                        status: $event,
                        id: para
                    }
            ...
            changeShowStatus($event, para) {
                this.axios.post(this.root + 'goods/change_show_status', {
                    params: {
                        status: $event,
                        id: para
                    }
